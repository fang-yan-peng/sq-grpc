...
import com.sq.common.io.UnsafeStringWriter;
...
public final class StringUtils {
    ...
    public static String removeEnd(final String str, final String... removes) {
        if (isAnyEmpty(str)) {
            return str;
        }
        if (isAnyEmpty(removes)) {
            return str;
        }
    ...
    public static String removeGrpcEnd(final String str) {
        return removeEnd(str, "BlockingClient", "FutureClient");
    }
