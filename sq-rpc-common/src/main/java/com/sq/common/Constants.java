...
public class Constants {
    ...
    public static final String SQ_RPC = "grpc";
    ...
    public static final String SQ_RPC_PROPERTIES_KEY = "sq.rpc.properties.file";

    public static final String DEFAULT_SQ_RPC_PROPERTIES = "sq.rpc.properties";
    ...
    public static final String DEFAULT_DIRECTORY = "grpc";
    ...
    public static final String DEFAULT_THREAD_NAME = "Sq_Rpc";
    ...
    public static final String SQ_RPC_PROTOCOL = SQ_RPC;
    ...
    public static final String SERVICE_INTERCEPTOR_KEY = "services.interceptor";
    ...
    public static final String DEFAULT_PROMPT = "sq-rpc>";
    ...
    @Deprecated
    public static final String SHUTDOWN_WAIT_SECONDS_KEY = "sq.rpc.services.shutdown.wait.seconds";

    public static final String SHUTDOWN_WAIT_KEY = "sq.rpc.services.shutdown.wait";
    ...
    public static final String STUB_EVENT_KEY = "grpc.stub.event";

    public static final boolean DEFAULT_STUB_EVENT = false;

    public static final String STUB_EVENT_METHODS_KEY = "grpc.stub.event.methods";
    ...
    public static final String GRPC_IP_TO_REGISTRY = "GRPC_IP_TO_REGISTRY";

    public static final String GRPC_PORT_TO_REGISTRY = "GRPC_PORT_TO_REGISTRY";

    public static final String GRPC_IP_TO_BIND = "GRPC_IP_TO_BIND";

    public static final String GRPC_PORT_TO_BIND = "GRPC_PORT_TO_BIND";
    ...
    public static final String TAG_KEY = "grpc.tag";

    public static final String FORCE_USE_TAG = "grpc.force.tag";
    ...
    public static final String PROTOCOLS_SUFFIX = "grpc.protocols.";

    public static final String PROTOCOL_SUFFIX = "grpc.protocol.";

    public static final String REGISTRIES_SUFFIX = "grpc.registries.";
    ...
    public static final String[] DEFAULT_REGISTER_PROVIDER_KEYS = {APPLICATION_KEY, CODEC_KEY, EXCHANGER_KEY, SERIALIZATION_KEY, CLUSTER_KEY, CONNECTIONS_KEY, DEPRECATED_KEY,
            GROUP_KEY, LOADBALANCE_KEY, MOCK_KEY, PATH_KEY, TIMEOUT_KEY, TOKEN_KEY, VERSION_KEY, WARMUP_KEY, WEIGHT_KEY, TIMESTAMP_KEY, GRPC_VERSION_KEY, RELEASE_KEY};

    public static final String[] DEFAULT_REGISTER_CONSUMER_KEYS = {APPLICATION_KEY, VERSION_KEY, GROUP_KEY, GRPC_VERSION_KEY, RELEASE_KEY};
     ...
     * metrics
     */
    public static final String GRPC_PROVIDER = "grpc.provider";
    public static final String GRPC_CONSUMER = "grpc.consumer";
    public static final String GRPC_PROVIDER_METHOD = "grpc.provider.method";
    public static final String GRPC_CONSUMER_METHOD = "grpc.consumer.method";
    public static final String SERVICE = "services";
    public static final String METHOD = "method";
    public static final String GRPC_GROUP = "grpc";
    ...
    public static final String MAX_CALLS_PER_CONNECTION_KEY = "max.calls.per.connection";
    /**
     * server config
     */
    public static final int MAX_MESSAGE_SIZE = 200 * 1024 * 1024;
    public static final int MAX_CALLS_PER_CONNECTION = 10000;
