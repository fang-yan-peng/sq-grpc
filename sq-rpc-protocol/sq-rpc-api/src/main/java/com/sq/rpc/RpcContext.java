...
import com.sq.common.threadpool.InternalThreadLocal;
 ...
 * For example: A invokes B, then B invokes C. On services B, RpcContext saves invocation info from A to B before B
        ...
        try {
            try {
                ...
                if (o != null) {
                    ...
                    // The services has a normal sync method signature, should get future from RpcContext.
                }
            } catch (Exception e) {
