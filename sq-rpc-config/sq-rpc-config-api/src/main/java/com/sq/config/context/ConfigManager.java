package com.sq.config.context;


import static com.sq.common.Constants.DEFAULT_KEY;
 ...
 *
 * <pre>{@code
 *  public void class SqRpcBuilder() {
 *
 *      public static SqRpcBuilder create() {
 *          return new SqRpcBuilder();
 *      }
 *
 *      public SqRpcBuilder application(ApplicationConfig application) {
